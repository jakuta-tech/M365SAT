...
function Build-CISMEx331($findings)
{
	...
	$inspectorobject = New-Object PSObject -Property @{
		ID			     = "CISMEx331"
		FindingName	     = "CIS MEx 3.3.1 - No SharePoint Online Information Protection Policies Set!"
		...
		RiskRating	     = "Medium"
		Priority		 = "Medium"
		References	     = @(@{ 'Name' = 'Top sensitivity labels applied to content'; 'URL' = "https://learn.microsoft.com/en-us/purview/data-classification-overview?view=o365-worldwide#top-sensitivity-labels-applied-to-content" },
