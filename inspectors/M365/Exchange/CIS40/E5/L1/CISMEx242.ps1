...
function Build-CISMEx242($findings)
{
	#Actual Inspector Object that will be returned. All object values are required to be filled in.
	$inspectorobject = New-Object PSObject -Property @{
		ID			     = "CISMEx242"
		FindingName	     = "CIS MEx 2.4.2 - Priority accounts do not have 'Strict protection' presets applied"
		...
		RiskRating	     = "High"
		Priority		 = "Medium"
		References	     = @(@{ 'Name' = 'Preset security policies in EOP and Microsoft Defender for Office 365'; 'URL' = "https://learn.microsoft.com/en-us/microsoft-365/security/office-365-security/preset-security-policies?view=o365-worldwide" },
...
function Audit-CISMEx242
{
	...
	try
	{
		...
		if ($AffectedOptions.Count -ne 0)
		{
			...
			$finalobject = Build-CISMEx242($AffectedOptions)
			return $finalobject
		}
		return $null
	}
