...
function Build-CISMEx215($findings)
{
	...
	$inspectorobject = New-Object PSObject -Property @{
		...
		RiskRating	     = "High"
		Priority		 = "High"
		References	     = @(@{ 'Name' = 'Safe Attachments for SharePoint, OneDrive, and Microsoft Teams'; 'URL' = "https://learn.microsoft.com/en-us/defender-office-365/safe-attachments-for-spo-odfb-teams-about" })
	}
