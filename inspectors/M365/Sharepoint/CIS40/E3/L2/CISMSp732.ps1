...
function Build-CISMSp732($findings)
{
	...
	$inspectorobject = New-Object PSObject -Property @{
		...
		PowerShellScript = 'Set-SPOTenantSyncClientRestriction -Enable -DomainGuids "786548DD-877B-4760-A749-6B1EFBC1190A; 877564FF-877B-4760-A749-6B1EFBC1190A"'
	...
	Try
	{
		...
		if(-not [string]::IsNullOrEmpty($Module))
		{
			...
			If ($ShareSettings.TenantRestrictionEnabled -ne $true)
			{
				...
				$endobject = Build-CISMSp732($ShareSettings.TenantRestrictionEnabled)
				return $endobject
			}
			return $null
		}
