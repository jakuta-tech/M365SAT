...
function Build-CISMOff138($findings)
{
	#Actual Inspector Object that will be returned. All object values are required to be filled in.
	$inspectorobject = New-Object PSObject -Property @{
		ID			     = "CISMOff138"
		FindingName	     = "CIS MOff 1.3.8 - Sways can be shared with people outside of your organization"
...
function Audit-CISMOff138
{
	try
	{
		...
		{
			$finalobject = Build-CISMOff138($AffectedSettings)
			return $finalobject
		}
		return $null
	}
