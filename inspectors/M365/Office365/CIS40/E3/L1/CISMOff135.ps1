...
function Build-CISMOff135($findings)
{
	#Actual Inspector Object that will be returned. All object values are required to be filled in.
	$inspectorobject = New-Object PSObject -Property @{
		ID			     = "CISMOff135"
		FindingName	     = "CIS MOff 1.3.5 - Internal phishing protection for Forms is disabled"
...
function Audit-CISMOff135
{
	try
	{
		...
		{
			$finalobject = Build-CISMOff135($AffectedSettings)
			return $finalobject
		}
		return $null
	}
