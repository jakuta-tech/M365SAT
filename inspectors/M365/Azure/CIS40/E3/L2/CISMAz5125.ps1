...
function Build-CISMAz5125($findings)
{
	...
	$inspectorobject = New-Object PSObject -Property @{
		...
		RiskRating	     = "High"
		Priority		 = "High"
		References	     = @(@{ 'Name' = 'Reauthentication prompts and session lifetime for Microsoft Entra multifactor authentication'; 'URL' = 'https://learn.microsoft.com/en-us/entra/identity/authentication/concepts-azure-multi-factor-authentication-prompts-session-lifetime' },
