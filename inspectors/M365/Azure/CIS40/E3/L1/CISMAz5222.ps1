...
function Build-CISMAz5222($findings)
{
	...
	$inspectorobject = New-Object PSObject -Property @{
		...
		RiskRating	     = "High"
		Priority		 = "High"
		References	     = @(@{ 'Name' = 'Require multifactor authentication for all users'; 'URL' = 'https://learn.microsoft.com/en-us/entra/identity/conditional-access/policy-all-users-mfa-strength' })
	}
