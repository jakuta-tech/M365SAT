...
function Build-CISMAz531($findings)
{
	...
	$inspectorobject = New-Object PSObject -Property @{
		...
		RiskRating	     = "Medium"
		Priority		 = "Medium"
		References	     = @(@{ 'Name' = 'What is Microsoft Entra Privileged Identity Management?'; 'URL' = 'https://learn.microsoft.com/en-us/entra/id-governance/privileged-identity-management/pim-configure' })
		}
