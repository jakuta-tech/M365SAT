...
function Build-CISMAz5229($findings)
{
	#Actual Inspector Object that will be returned. All object values are required to be filled in.
	$inspectorobject = New-Object PSObject -Property @{
		ID			     = "CISMAz5229"
		FindingName	     = "CIS MAz 5.2.2.9 - Verify if you have an Azure AD Identity Protection sign-in risk policy enabled"
...
function Audit-CISMAz5229
{
	try
	{
		...
		{
			$finalobject = Build-CISMAz5229($Violation)
			return $finalobject
		}
		return $null
	}
